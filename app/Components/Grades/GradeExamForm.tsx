...
export default function GradeExamForm({
    examId,
    maxGrade,
    examSubmissionId,
    grade,
    ...
    const gradeExamMutation = useMutation<Grade, Error, GradeRequest>({
        ...
        async onSuccess(data) {
            queryClient.setQueryData(['getExamQuery', { examId: examId }], (old: Exam) => {
                return {
                    ...old, examSubmissions: old.examSubmissions.map(a => a.id == examSubmissionId ? {
        ...
        <>
            ...
            <div className="modal-footer">
                ...
                <LoadingButton
                    ...
                    loading={gradeExamMutation.isPending}
                >
                    Calificar
                </LoadingButton>
            </div>
